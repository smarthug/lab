...
export default function Main() {
  ...
  function Animate() {
    ...
    if (verticalAxis !== 0 ) {
      ...
      tmpMatrix.lookAt(new THREE.Vector3(0,0,0),unitMoveVector,new THREE.Vector3(0,1,0));
...
function Mover() {
  //   player.rotateY(cameraVector.y)
  //   player.rotateY(cameraVector.y)
  // player.rotation.set(camera.getWorldDirection(cameraVector))
  // player.setRotationFromAxisAngle(cameraVector)
  // console.log(camera.rotation)
  // tmpEuler.copy(camera.rotation)
  // tmpEuler.z=0
  // console.log(tmpEuler)
  // player.setRotationFromEuler(tmpEuler)
  // player.setRotationFromEuler(new THREE.Euler(0,camera.rotation.y,0))
  console.log(moveVector);
  // tmpQuaternion.setFromAxisAngle(moveVector,0);
  // tmpQuaternion.setFromUnitVectors(new THREE.Vector3(0,0,0),moveVector);
  // console.log(tmpQuaternion)
  // player.setRotationFromQuaternion(tmpQuaternion)
