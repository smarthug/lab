...
(function (ns) {
    ...
    ns.Joystick = function ($container, size, params) {
        ...
        var onbuttonup = function (event) {
            ...
            if (event.originalEvent.pointerId) {
                ...
                for (let i = 0, l = event.originalEvent.changedTouches.length; i < l; i++) {
    ...
    ns.Joystick.prototype.addEventListener = function (type, listener) {
    ...
    ns.Joystick.prototype.dispatchEvent = function ( event ) {
